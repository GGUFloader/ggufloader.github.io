...
related_docs: ["addon-development", "smart-floater-example", "package-structure"]
difficulty: "advanced"
...
For comprehensive testing examples, see the [Smart Floater Example](/docs/smart-floater-example/ "Complete addon with testing examples") which includes both unit and integration tests.
...
- [Smart Floater Example](/docs/smart-floater-example/ "Real-world addon implementation with detailed code analysis") - Complete addon example
- [Addon Development Guide](/docs/addon-development/ "Step-by-step tutorial for creating addons") - Step-by-step development guide
- [Package Structure](/docs/package-structure/ "Understanding GGUF Loader's technical architecture") - Technical architecture
- [Installation Guide](/docs/installation/ "Development environment setup") - Development setup
